...
void Magnetizacion(int *ptr_magn, double *salida_magn, int sitiosm){
	double m=0;
...
int main(){
	...
	int L=30; //"largo" del lado de la red cuadrada PARA HACER POSTA PONER L=50,30,80
	...
	*/
	...
	for(int xx=1; xx<datos; xx++){
		...
		for(int pasos=0; pasos<MCS; pasos++){
			...
			///---------------
			/* Medidas de variables termodinamicas */
			double EEE=0; //variable auxiliar para poder calcular E y cv
